...
*** Article coming soon: description of all parameters below ***
...
[output]
  ...
  db_write: False   # Turns on database functionalities: name of a database to write the data in, which should already exist
  db_name: # Name of db to write in
