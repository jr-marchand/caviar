...
This article is complementary to the [--> command line use <--]({% link _posts/Using CAVIAR/2020-04-23-caviar-cmdline.md %}) of CAVIAR.  
...
The parameters can be in any order, and see [--> this article <--]({% link _posts/Using CAVIAR/2020-04-23-caviar-cmdline.md %}) for more details.  
